...
public class Earthquake extends ActionBarActivity {
    ...
    public void goToEOne(View view){
        Intent intent = new Intent(this, eSafetyTips.class);
        startActivity(intent);
    }

    public void goToETwo(View view){
        Intent intent = new Intent(this, eShaking.class);
        startActivity(intent);
    }
